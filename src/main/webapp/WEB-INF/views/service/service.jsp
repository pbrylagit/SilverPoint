		...
		<div class="row">
			<table class="table table-hover">
				<tr>
					...
					<th><spring:message code="service.startDate" /></th>
					<th><spring:message code="service.finishDate" /></th>
				...
				<c:forEach items="${serviceList}" var="service">
					<tr>
						...
						<td>${service.price}<c:if test="${service.price != ''}">PLN</c:if></td>
						<td>${service.startDate}</td>
						<td>${service.finishDate}</td>
						<td><c:choose>
