...
<title><spring:message code="addService.title" /></title>
</head>
<body>
	<section class="container">
		<form:form modelAttribute="newService">
			<fieldset>
				<legend>
					<spring:message code="addService.legend" />
				</legend>
				<input type="hidden" id="adderUserName" name="adder" value="${adderUserName}"/>
				...
				<!-- 
				<form:input id="startDate" name="startDate" path="startDate" value="${startDate}"/>
				-->
				<br>
				...
				<textarea id="service" name="service" class="form-control" rows="4"></textarea>
				<br> 
				<label for="damage"><spring:message code="addService.damage" /></label>
				<textarea id="damage" name="damage" class="form-control" rows="4"></textarea>
				<br> 
				...
				<br> 
				<label for="price"><spring:message code="addService.price" /></label>
				<div class="row">
					<div class="col-xs-4">
				...
				<div class="row">
					<div class="col-xs-4">
						<select class="form-control" name="warranty" id="warranty">
							<option value="outOfWarranty"><spring:message code="addService.outOfWarranty" /></option>
							<option value="warranty"><spring:message code="addService.warranty" /></option>
						</select>
					</div>
					<div class="col-xs-4">
					...
					<div class="col-xs-4">
						<select class="form-control" name="status" id="status">
							<option value="notDone"><spring:message code="addService.notDone" /></option>
							<option value="done"><spring:message code="addService.done" /></option>
						</select>
					</div>
				</div>
				<br>
